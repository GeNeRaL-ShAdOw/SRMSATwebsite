...
function Missions()
{
    ...
    <div className='borderline-mssn'>
        ...
        <font size='+2' className="WWD-box-content">
            <p>SRMSAT HAS A PROUD HISTORY OF ITS MISSIONS, AND HAS PROVED TIME AND AGAIN TO BE ONE OF THE BEST CLUBS IN SRM. WITH ITS STELLAR PERFORMANCE AND EVER CONTINUING RESEARCH INTO HUMAN INTERACTION WITH THE VOID, SRMSAT HAS BEEN PROVIDED WITH CUTTING SPACE EDGE TECHNOLOGY ALLOWING IT TO REACH ITS PEAK. </p>
